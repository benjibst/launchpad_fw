...
esp_err_t MAX98357A_init(MAX98357A_config_t *config, MAX98357A_handle_t *handle)
{
    ...
    ESP_LOGI("MAX98357A", "Initializing I2S");

    i2s_chan_handle_t tx_handle;
    i2s_chan_config_t chan_cfg = I2S_CHANNEL_DEFAULT_CONFIG(I2S_NUM_AUTO, I2S_ROLE_MASTER);

    ESP_LOGI("MAX98357A", "Initializing I2S channel");
    ...
    ESP_LOGI("MAX98357A", "Initializing I2S channel in standard mode");
    ESP_ERROR_CHECK(i2s_channel_init_std_mode(tx_handle, &std_cfg));

    ESP_LOGI("MAX98357A", "Enabling I2S channel");
